...
@test:Config
function puzzleWithThreeLetters() {
...
@test:Config
function solutionMustHaveUniqueValueForEachLetter() {
    Assert.Throws<ArgumentException>(() => Alphametics.Solve("A == B"));
}

@test:Config
function leadingZeroSolutionIsInvalid() {
    Assert.Throws<ArgumentException>(() => Alphametics.Solve("ACA + DD == BD"));
}

@test:Config
function puzzleWithTwoDigitsFinalCarry() {
...
@test:Config
function puzzleWithFourLetters() {
...
@test:Config
function puzzleWithSevenLetters() {
...
@test:Config
function puzzleWithEightLetters() {
...
@test:Config
function puzzleWithTenLettersAnd_199Addends() {
